...
Keep it light for Indian heat. Stop after Plan. I'll hit Build.`,
    sample: {
      ...
      result:
        "Vessel filled. Formula saved to the Plan. Refine in Chat, or Mix to hear the tutor.",
    },
  },
  {
    id: "refine-diff",
...
Show the revised Plan with % and mapping. Wait for Build.`,
  ...
  },
  {
    ...
    win: "Not only perfume. Pour real Lab chemicals, Mix, and get a tutor explanation.",
    prompt: "Walk me through making a simple copper sulfate solution on the desk, step by step.",
    sample: {
      kind: "chem",
      title: "Desk + tutor result",
      ...
      onDesk: [
        ...
        "Mix → tutor opens with the reaction notes",
      ],
      result:
        "Blue well on ebony wood. Tutor explains hydration / dissolution. XP if it is a first discovery.",
    },
  },
  {
    id: "full-atelier",
