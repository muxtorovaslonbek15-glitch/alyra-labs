      ...
      <div className="space-y-4">
        ...
        <div className="overflow-hidden rounded-xl border border-lab-line bg-white">
          <table className="w-full text-left text-sm">
            <thead>
              <tr className="border-b border-lab-line/70 bg-lab-wash/60 text-[10px] font-semibold uppercase tracking-label text-lab-muted">
      ...
      <div className="space-y-4">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <div className="rounded-xl border border-lab-ink/20 bg-lab-wash px-4 py-3">
            <p className="text-[10px] font-semibold uppercase tracking-label text-lab-ink">
              After
            </p>
...
export function DemoCard({ demo }: { demo: GuideDemo }) {
  ...
  async function onTryInChat() {
    ...
    window.open(
      "/lab?audience=composer&tab=chat",
      "_blank",
      "noopener,noreferrer",
    );
    ...
    <article className="overflow-hidden rounded-2xl border border-lab-line bg-lab-panel shadow-[0_1px_0_rgba(12,12,12,0.04)]">
      <div className="border-b border-lab-line/70 px-4 py-5 sm:px-6">
        <div className="flex flex-wrap items-center gap-2">
          <span
            className={`rounded-md border px-2 py-0.5 text-[10px] font-semibold uppercase tracking-label ${LEVEL_STYLE[demo.level]}`}
          >
            {demo.level}
          </span>
      ...
      <div className="grid gap-0 lg:grid-cols-2">
        ...
        <div className="bg-lab-wash/35 px-4 py-5 sm:px-6">
          <p className="mb-3 text-[10px] font-semibold uppercase tracking-label text-lab-muted">
